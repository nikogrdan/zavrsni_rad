"""
Django settings for emailcalendar project.
...
SECRET_KEY = 'django-insecure-l&)e8523mn&+)%f8+4b93ynd9g5ul)8!c+)q(=sgai(^&4tre#'
...
ROOT_URLCONF = 'emailcalendar.urls'
...
WSGI_APPLICATION = 'emailcalendar.wsgi.application'
